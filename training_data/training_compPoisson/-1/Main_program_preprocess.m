...
[nxyz,nc,n_Nodes,n_El,el_centroid,V_el,Element_Neighbors, Element_Neighbors_common_nodes, Node_El]=Nodal_Values_preprocess(job,n_header_lines, options);
disp(' ')
...
band_jump,grain,scaling,n_grain_fail,t2,Mantle_slip_sys,Core_slip_sys,Element_Neighbors, Element_Neighbors_common_nodes, options, V_el, V_grn, new_to_old_grains, Node_El);
