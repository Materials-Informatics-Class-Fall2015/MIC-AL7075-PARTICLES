...
options = {
    ...
    'input':'main_4',
    'interactive':None,
    'job':'Results_main_4.inp887503.dedicated-sched.pace.gatech.edu',
    'lanczos':OFF,
    'libs':[],
    'massDiffusion':OFF,
    ...
    'rezone':OFF,
    'runCalculator':OFF,
    'scratch':'/nv/hp16/pkern3/scratch/testing_data/Results_887503.dedicated-sched.pace.gatech.edu',
    'soils':OFF,
    ...
    'tmpdir':'/nv/hp16/pkern3/scratch/testing_data/Results_887503.dedicated-sched.pace.gatech.edu',
    'tracer':OFF,
    'user':'Al_v144.f',
    'visco':OFF,
}
