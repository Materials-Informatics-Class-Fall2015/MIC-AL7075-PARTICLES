...
options = {
    ...
    'input':'main_0',
    'interactive':None,
    'job':'Results_main_0.inp887499.dedicated-sched.pace.gatech.edu',
    'lanczos':OFF,
    'libs':[],
    'massDiffusion':OFF,
    ...
    'rezone':OFF,
    'runCalculator':OFF,
    'scratch':'/nv/hp16/pkern3/scratch/testing_data/Results_887499.dedicated-sched.pace.gatech.edu',
    'soils':OFF,
    ...
    'tmpdir':'/nv/hp16/pkern3/scratch/testing_data/Results_887499.dedicated-sched.pace.gatech.edu',
    'tracer':OFF,
    'user':'Al_v144.f',
    'visco':OFF,
}
